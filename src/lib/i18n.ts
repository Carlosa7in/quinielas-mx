...
export const translations = {
  es: {
    home: {
      ...
      costoValor: "Desde $20 MXN",
      aciertosLabel: "¿Quién gana?",
      aciertosValor: "El que más aciertos tenga",
  ...
  en: {
    home: {
      ...
      costoValor: "From $20 MXN",
      aciertosLabel: "Who wins?",
      aciertosValor: "Most correct picks wins",
      modalidadLabel: "Mode:",
